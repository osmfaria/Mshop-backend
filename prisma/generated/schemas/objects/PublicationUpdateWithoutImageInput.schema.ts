...
import { UserUpdateOneRequiredWithoutPublicationNestedInputObjectSchema } from '../internals';;
import { CommentUpdateManyWithoutPublicationNestedInputObjectSchema } from '../internals';

export const PublicationUpdateWithoutImageInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  user: UserUpdateOneRequiredWithoutPublicationNestedInputObjectSchema,  Comment: CommentUpdateManyWithoutPublicationNestedInputObjectSchema
});
