...
export const PublicationUpdateWithoutCommentInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  user: UserUpdateOneRequiredWithoutPublicationNestedInputObjectSchema,  Image: ImageUpdateManyWithoutPublicationNestedInputObjectSchema
});
