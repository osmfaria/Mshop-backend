...
export const UserUncheckedUpdateWithoutAddressInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  account_type: Yup.mixed().oneOfSchemas([EnumAccount_TypeFieldUpdateOperationsInputObjectSchema]),  Publication: PublicationUncheckedUpdateManyWithoutUserNestedInputObjectSchema,  Comment: CommentUncheckedUpdateManyWithoutUserNestedInputObjectSchema
});
