...
export const UserUncheckedUpdateWithoutPublicationInputObjectSchema = Yup.object({
...
BoolFieldUpdateOperationsInputObjectSchema]),  account_type: Yup.mixed().oneOfSchemas([EnumAccount_TypeFieldUpdateOperationsInputObjectSchema]),  Address: AddressUncheckedUpdateOneWithoutUserNestedInputObjectSchema,  Comment: CommentUncheckedUpdateManyWithoutUserNestedInputObjectSchema
});
