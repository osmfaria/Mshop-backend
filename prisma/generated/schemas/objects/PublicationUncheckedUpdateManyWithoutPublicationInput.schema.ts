...
export const PublicationUncheckedUpdateManyWithoutPublicationInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  vehicle_type: Yup.mixed().oneOfSchemas([EnumVehicle_TypeFieldUpdateOperationsInputObjectSchema]),  createdAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema]),  updatedAt: Yup.mixed().oneOfSchemas([DateTimeFieldUpdateOperationsInputObjectSchema])
});
