...
export const PublicationUncheckedUpdateWithoutCommentInputObjectSchema = Yup.object({
...
StringFieldUpdateOperationsInputObjectSchema]),  Image: ImageUncheckedUpdateManyWithoutPublicationNestedInputObjectSchema
});
